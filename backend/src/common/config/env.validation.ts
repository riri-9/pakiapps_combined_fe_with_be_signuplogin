...
export interface EnvironmentVariables {
  ...
  SUPABASE_MOBILE_UPLOAD_BUCKET?: string;
...
export function validateEnv(env: RawEnv): EnvironmentVariables {
  ...
  const SUPABASE_MOBILE_UPLOAD_BUCKET = env['SUPABASE_MOBILE_UPLOAD_BUCKET'] as
    | string
    | undefined;
  ...
  return {
    ...
    SUPABASE_ANON_KEY,
    SUPABASE_SERVICE_ROLE_KEY,
    ...(SUPABASE_MOBILE_UPLOAD_BUCKET ? { SUPABASE_MOBILE_UPLOAD_BUCKET } : {}),
    ALLOWED_ORIGINS,
